...
class TestCosmosIntegration(unittest.TestCase):
    ...
    @patch.dict(os.environ, {'COSMOS_ENDPOINT': 'https://test-cosmos.documents.azure.com:443/'})
...
class TestEnvironmentConfiguration(unittest.TestCase):
    ...
    def test_environment_variables_default(self):
        ...
        self.assertEqual(database_name, os.environ.get('COSMOS_DATABASE_NAME', 'webapp-db'))
        self.assertEqual(container_name, os.environ.get('COSMOS_CONTAINER_NAME', 'visitor-logs'))
